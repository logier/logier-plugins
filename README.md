...
| 名称 | 指令 | 名称 | 指令 |
|-------|------ |-------|------ |
| [表情包仓库](#表情包系列) | #表情包 | [表情包小偷](#表情包系列) | 发送消息随机触发 |
| [戳一戳表情](#表情包系列) | 戳一戳触发 | [保存表情包](#表情包系列) | #存(表情\|涩图) <br> #查看(表情包\|涩图)+序号？<br> #删除(表情包\|涩图)+序号  | 
| [定时发图](#定时系列) | 定时推送 | [摸鱼日历](#定时系列) | 定时推送 | 
| [今日新闻](#定时系列) | 定时推送 | [城市天气](#定时系列) | 定时推送 |  
| [今日运势](#运势系列) | #今日运势 #悔签 | [cp生成器](#运势系列) | #今日cp | 
| [算一卦](#运势系列) | #算卦 #悔卦 | [塔罗牌](#运势系列) | #塔罗牌 #占卜 #彩虹塔罗牌 | 
| [签到](#运势系列) | #签到 | [番剧](#定时系列) | #今日番剧 |
| [自定义图片api](#小修系列) | 自定义指令 | [进退群通知](#小修系列) | 进退群触发 | 
| [问候回复](#小修系列) |  打招呼触发 <br> 例如早安、晚安 | [订阅小说](#小修系列) | #搜小说+轻小说书名 <br> #订阅小说+轻小说书名 <br> #查看订阅小说 |
| [潜伏模板](#小修系列) |  发送消息随机触发 |  |  |
<br>
